        ...
        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((s, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-card transition-colors hover:border-primary/50"
            >
              ...
              <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-brand-gradient/10 text-primary">
              ...
              <button
                ...
                className="relative mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-primary transition-transform hover:gap-2.5"
              >
                View details
          ...
          >
            ...
            >
              ...
              <div className="relative flex items-center gap-4 overflow-hidden bg-brand-gradient px-6 py-8">
                ...
                <button
                  onClick={() => setSelected(null)}
                  className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full bg-slate-900/30 text-white"
                >
                  <X size={16} />
                </button>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 rounded-full bg-brand-gradient px-5 py-2.5 text-sm font-semibold text-bg"
                  >
                    Start a project
                    <ArrowRight size={15} />
                  </button>
                  <button
                    onClick={() => setSelected(null)}
                    className="rounded-full border border-border px-5 py-2.5 text-sm font-semibold text-slate-900"
                  >
                    Close
                  </button>
                </div>
